...
public class products extends JFrame {
	...
	public products(final String n, final int cusid) {
		...
		lblNewLabel_3.setBounds(20, 139, 57, 25);
		...
		sugarqn.setBounds(109, 137, 66, 27);
		panel.add(sugarqn);
		...
		JLabel lblNewLabel_3_1 = new JLabel("APPLE");
		lblNewLabel_3_1.setFont(new Font("Tahoma", Font.BOLD, 13));
		lblNewLabel_3_1.setBounds(352, 139, 57, 25);
		...
		JLabel lblNewLabel_3_2 = new JLabel("ONION");
		lblNewLabel_3_2.setFont(new Font("Tahoma", Font.BOLD, 13));
		lblNewLabel_3_2.setBounds(30, 410, 57, 25);
		...
		JLabel lblNewLabel_3_3 = new JLabel("RICE");
		lblNewLabel_3_3.setFont(new Font("Tahoma", Font.BOLD, 13));
		lblNewLabel_3_3.setBounds(342, 410, 57, 25);
		...
		btnViewSimilarProducts.setBounds(331, 510, 183, 32);
		...
		lblNewLabel_1_1.setBounds(25, 32, 168, 117);
		panel_1.add(lblNewLabel_1_1);
		
		JLabel lblNewLabel_3_4 = new JLabel("BAG");
		lblNewLabel_3_4.setFont(new Font("Tahoma", Font.BOLD, 13));
		lblNewLabel_3_4.setBackground(Color.LIGHT_GRAY);
		lblNewLabel_3_4.setBounds(35, 160, 57, 25);
		...
		glassqn.setBounds(412, 158, 66, 27);
		panel_1.add(glassqn);
		...
		watchqn.setBounds(111, 427, 66, 27);
		panel_1.add(watchqn);
		...
		penbt.setBounds(347, 477, 131, 23);
		panel_1.add(penbt);
		...
		btnViewSimilarProducts_1.setBounds(323, 519, 183, 32);
		...
		lblNewLabel_1_2.setBounds(21, 30, 176, 117);
		panel_2.add(lblNewLabel_1_2);
		
		JLabel lblNewLabel_3_8 = new JLabel("ADAPTER");
		lblNewLabel_3_8.setFont(new Font("Tahoma", Font.BOLD, 13));
		lblNewLabel_3_8.setBackground(Color.LIGHT_GRAY);
		lblNewLabel_3_8.setBounds(31, 158, 66, 25);
		...
		adapterqn.setBounds(120, 156, 66, 27);
		...
		adapterbt.setBounds(41, 204, 131, 23);
		...
		budsqn.setBounds(419, 156, 66, 27);
		panel_2.add(budsqn);
		...
		powerqn.setBounds(120, 419, 66, 27);
		panel_2.add(powerqn);
		...
		keybt.setBounds(330, 463, 131, 23);
		panel_2.add(keybt);
		...
		btnViewSimilarProducts_1_1.setBounds(320, 508, 183, 32);
		...
		cricketqn.setBounds(129, 158, 66, 27);
		...
		footballqn.setBounds(420, 158, 66, 27);
		...
		hockeyqn.setBounds(129, 400, 66, 27);
		...
		hockeybt.setBounds(40, 443, 131, 23);
		...
		tennisqn.setBounds(420, 400, 66, 27);
		...
		btnViewSimilarProducts_1_2.setBounds(326, 501, 183, 32);
		...
		gtable.setFont(new Font("Consolas", Font.BOLD, 15));
		...
		ftable = new JTable();
		ftable.setFont(new Font("Consolas", Font.BOLD, 15));
		...
		gatable.setFont(new Font("Consolas", Font.BOLD, 15));
		...
		stable.setFont(new Font("Consolas", Font.BOLD, 15));
		...
		lblNewLabel_5_1.setBounds(898, 528, 135, 52);
		...
		total.setBounds(1031, 531, 177, 36);
		...
		pay.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) 
			{
				try
				{
					Connection con = jdbc.getCon();
					Statement st = con.createStatement();
					String pass="1234567890ABCDEFGHIJKLMNOPQRSTUVQXYZ";
		...
		receipt.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) 
			{
				try {
					...
					//t.setModel(table.getModel());
					bill b = new bill(itemname,itemquantity,itemprice,tot);
					b.setVisible(true);
					itemname.clear();
					itemquantity.clear();
					itemprice.clear();
		...
		receipt.setFont(new Font("Tahoma", Font.BOLD, 12));
		receipt.setBorder(new LineBorder(new Color(0, 0, 0)));
		receipt.setBounds(987, 591, 122, 43);
